<template>
  <div class="container" v-once>
    <h2>Privacy Policy <span class="heading-desc">(last updated: {{ lastUpdatedDate }})</span></h2>
    <div>
      <p>WhoAreMyReps.com ("we", "us", "our") operates the Who Are My Reps website (the "Service").</p>
      ...
      <p>While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you. Personally identifiable information may include, but is not limited to, your email address, name, phone number, or other information ("Personal Information").</p>
      ...
      <p class="text-bold">Location Information</p>
      ...
      <p class="text-bold">Service Providers</p>
      ...
      <p class="text-bold">Links To Other Sites</p>
      <p>Our Service may contain links to other sites that are not operated by us. If you click on a third party link, you will be directed to that third party’s site. We strongly advise you to review the Privacy Policy of every site you visit.</p>
      <p>We have no control over, and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>

      <p class="text-bold">Children’s Privacy</p>
      ...
      <p>This Privacy Policy is effective as of {{ lastUpdatedDate }} and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.</p>
      ...
      <p>If you have any questions about this Privacy Policy, please <router-link to="/about">contact us</router-link>.</p>
    </div>
  </div>
</template>
